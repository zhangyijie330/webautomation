...
/**
 * U24查看变现结束后的账户信息 xhh-7330 ~ xhh-7341
 * 
 * @author 002194
 * 
 */
public class YYS008_CashEnd_ViewAccount_U24 extends TestDriver {
	public static KeyWords	kw;
	public static boolean	bResult			= true;
	public static boolean	bFinalResult	= true;
	private String			Product_id		= "SDT006";
	private String			sdtProductId	= "SDT007";
	private String			userNumber		= "u24";
